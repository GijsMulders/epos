# -*- coding: utf-8 -*-
#
# epos documentation build configuration file, created by
...
from EPOS import __version__, __shortversion__
...
version = __shortversion__ # was u'1.1'
# The full version, including alpha/beta/rc tags.
#release = u'1.1.0.dev0'
release = __version__
...
latex_documents = [
    (master_doc, 'epos.tex', u'epos Documentation',
     u'Gijs Mulders', 'manual'),
]
...
man_pages = [
    (master_doc, 'epos', u'epos Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'epos', u'epos Documentation',
     author, 'epos', 'One line description of project.',
     'Miscellaneous'),
]
